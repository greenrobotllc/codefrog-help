---
title: Mac App Store Help
redirect_from:
  - /help/index.php?flavor=mas
  - /help/mas/index.php
layout: help
---
...
Welcome to the CodeFrog help documentation for Mac App Store users.
...
*Browse the topics above to get the most out of CodeFrog.*
